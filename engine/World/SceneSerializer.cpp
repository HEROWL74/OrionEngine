...
namespace Engine::World
{
    ...
    nlohmann::json SceneSerializer::serializeRenderEntry(
        const Renderer::RenderEntry& entry, const Scene& /*scene*/)
    {
        nlohmann::json j;
    ...
    Utils::VoidResult SceneSerializer::deserializeRenderComponent(
        ...
        const nlohmann::json& json)
    {
        auto renderType = static_cast<Renderer::RenderableType>(json.value("renderableType", 0));
    ...
    nlohmann::json SceneSerializer::serializeMaterial(const Renderer::Material* material)
    {
        nlohmann::json j;
        j["name"] = "Material";
