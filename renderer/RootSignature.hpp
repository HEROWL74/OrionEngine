...
public:
  ...
  // Add CBV (b0, b1, b2, ...)
  RootSignature &
  addCBV(uint32_t shaderRegister,
  ...
  RootSignature &addSRVTable(
      uint32_t count, uint32_t baseRegister,
...
[[nodiscard]] Utils::Result<RootSignature> createModel(Device *device);
} // namespace RootSignatureFactory
} // namespace Renderer
